          ...
          <div className="col-lg-6 text-center text-lg-right">
            ...
            {!valueContext.user ?
              ...
              <button
                ...
                data-toggle="dropdown"
              >
               Welcome, {valueContext.user.name}
              </button>
              <div className="dropdown-menu dropdown-menu-right">
                <button
                  className="dropdown-item"
            ...
            <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
              ...
              >
                <div className="navbar-nav mr-auto py-0">
                  <Link to="/" className={colorBtn === "/" ? "nav-item nav-link active" : "nav-item nav-link"} >
                    Home 
                  </Link>
                  <Link to="/products" className={colorBtn === "/products" ? "nav-item nav-link active" : "nav-item nav-link"}>
                    Shop
                  </Link>
                  {/* <Link to="/detail" className={colorBtn === "/detail" ? "nav-item nav-link active" : "nav-item nav-link"}>
                   ...
                   <Link to="/cart" className={colorBtn === "/cart" ? "nav-item nav-link active" : "nav-item nav-link"}>
                   Shopping Cart
                  </Link>
                  <Link to="/contact" className={colorBtn === "/contact" ? "nav-item nav-link active" : "nav-item nav-link"}>
                    Contact
                  </Link>
                  {!!valueContext.user &&
                     <Link to="/order" className={colorBtn === "/order" ? "nav-item nav-link active" : "nav-item nav-link"}>
                ...
                <div className="navbar-nav ml-auto py-0 d-none d-lg-block">
                  <Link to='/favorite' className="btn px-0">
                    ...
                    <span
                      ...
                      style={{ paddingBottom: 2 }}
                    >
                      {valueContext.dataLocalStorage !== null ? valueContext.dataLocalStorage.length : 0}
                    </span>
                  </Link>
